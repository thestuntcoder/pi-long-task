...
assert.equal(success.completedDuringGrace, false);
assert.equal(success.outputObserved, true);
assert.equal(success.graceExpired, false);
...
assert.equal(timeout.completedDuringGrace, false);
assert.equal(timeout.outputObserved, true);
assert.equal(timeout.graceExpired, true);
...
assert.equal(aborted.completedDuringGrace, false);
assert.equal(aborted.outputObserved, false);
assert.equal(aborted.graceExpired, false);
